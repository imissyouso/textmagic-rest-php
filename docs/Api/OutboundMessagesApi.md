...
# **sendMessage**
> \TextMagic\Models\SendMessageResponse sendMessage($sendSmsInputObject)
...
$sendSmsInputObject = new \TextMagic\Models\SendSmsInputObject(); // \TextMagic\Models\SendSmsInputObject | 

try {
    $result = $apiInstance->sendMessage($sendSmsInputObject);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **sendSmsInputObject** | [**\TextMagic\Models\SendSmsInputObject**](../Model/SendSmsInputObject.md)|  | [optional]
