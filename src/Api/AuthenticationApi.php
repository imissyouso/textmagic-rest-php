...
class AuthenticationApi
{
     ...
     *
     * @param  \TextMagic\Models\DoAuthInputObject $doAuthInputObject doAuthInputObject (optional)
     *
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TextMagic\Models\DoAuthResponse
     */
    public function doAuth($doAuthInputObject = null)
    {
     ...
     * Authenticate user by given username and password.
     *
     * @param  \TextMagic\Models\DoAuthInputObject $doAuthInputObject (optional)
     *
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TextMagic\Models\DoAuthResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function doAuthWithHttpInfo($doAuthInputObject = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doAuthAsync($doAuthInputObject = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doAuthAsyncWithHttpInfo($doAuthInputObject = null)
    {
        $returnType = '\TextMagic\Models\DoAuthResponse';
        $request = $this->doAuthRequest($doAuthInputObject);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function doAuthRequest($doAuthInputObject = null)
    {
