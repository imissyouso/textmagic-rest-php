...
class ContactListsApi
{
     ...
     *
     * @param  \TextMagic\Models\CreateListInputObject $createListInputObject createListInputObject (optional)
     *
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TextMagic\Models\ResourceLinkResponse
     */
    public function createList($createListInputObject = null)
    {
     ...
     * Create a new list from the submitted data.
     *
     * @param  \TextMagic\Models\CreateListInputObject $createListInputObject (optional)
     *
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TextMagic\Models\ResourceLinkResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createListWithHttpInfo($createListInputObject = null)
    {
        $returnType = '\TextMagic\Models\ResourceLinkResponse';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createListAsync($createListInputObject = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createListAsyncWithHttpInfo($createListInputObject = null)
    {
        $returnType = '\TextMagic\Models\ResourceLinkResponse';
        $request = $this->createListRequest($createListInputObject);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createListRequest($createListInputObject = null)
    {
     ...
     *
     * @param  int $id id (required)
     * @param  \TextMagic\Models\DeleteListContactsBulkInputObject $deleteListContactsBulkInputObject deleteListContactsBulkInputObject (optional)
     *
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteListContactsBulk($id, $deleteListContactsBulkInputObject = null)
    {
        $this->deleteListContactsBulkWithHttpInfo($id, $deleteListContactsBulkInputObject);
    }
     ...
     *
     * @param  int $id (required)
     * @param  \TextMagic\Models\DeleteListContactsBulkInputObject $deleteListContactsBulkInputObject (optional)
     *
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteListContactsBulkWithHttpInfo($id, $deleteListContactsBulkInputObject = null)
    {
        $returnType = '';
        $request = $this->deleteListContactsBulkRequest($id, $deleteListContactsBulkInputObject);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteListContactsBulkAsync($id, $deleteListContactsBulkInputObject = null)
    {
        return $this->deleteListContactsBulkAsyncWithHttpInfo($id, $deleteListContactsBulkInputObject)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteListContactsBulkAsyncWithHttpInfo($id, $deleteListContactsBulkInputObject = null)
    {
        $returnType = '';
        $request = $this->deleteListContactsBulkRequest($id, $deleteListContactsBulkInputObject);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteListContactsBulkRequest($id, $deleteListContactsBulkInputObject = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
