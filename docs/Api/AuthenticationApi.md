...
------------- | ------------- | ------------- | -------------
 **checkPhoneVerificationCodeInputObject** | [**\TextMagic\Models\CheckPhoneVerificationCodeInputObject**](../Model/CheckPhoneVerificationCodeInputObject.md)|  | [optional]
...
# **doAuth**
> \TextMagic\Models\DoAuthResponse doAuth($authInputObject)
...
$authInputObject = new \TextMagic\Models\AuthInputObject(); // \TextMagic\Models\AuthInputObject | 

try {
    $result = $apiInstance->doAuth($authInputObject);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **authInputObject** | [**\TextMagic\Models\AuthInputObject**](../Model/AuthInputObject.md)|  | [optional]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **updatePasswordInputObject** | [**\TextMagic\Models\UpdatePasswordInputObject**](../Model/UpdatePasswordInputObject.md)|  | [optional]
