...
[**deleteByIds**](ContactsApi.md#deleteByIds) | **POST** /api/v2/contacts/delete | Delete contact by given ID(s) or delete all contacts.
...
# **deleteByIds**
> deleteByIds($deleteContactsByIdsInputObject)
...
try {
    $apiInstance->deleteByIds($deleteContactsByIdsInputObject);
} catch (Exception $e) {
    echo 'Exception when calling ContactsApi->deleteByIds: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getBlockedContacts**
> \TextMagic\Models\InlineResponse2004 getBlockedContacts($page, $limit, $query, $orderBy, $direction)
...
# **getFavourites**
> \TextMagic\Models\InlineResponse2003 getFavourites($page, $limit, $query)
...
[**\TextMagic\Models\InlineResponse2003**](../Model/InlineResponse2003.md)
...
# **getUnsubscribers**
> \TextMagic\Models\InlineResponse2007 getUnsubscribers($page, $limit)
...
[**\TextMagic\Models\InlineResponse2007**](../Model/InlineResponse2007.md)
...
# **getUserContacts**
> \TextMagic\Models\InlineResponse2004 getUserContacts($page, $limit, $shared, $orderBy, $direction)
...
# **searchContacts**
> \TextMagic\Models\InlineResponse2004 searchContacts($page, $limit, $shared, $ids, $listId, $includeBlocked, $query, $local, $country, $orderBy, $direction)
...
# **uploadContactAvatar**
> \TextMagic\Models\InlineResponse201 uploadContactAvatar($image, $id)
...
[**\TextMagic\Models\InlineResponse201**](../Model/InlineResponse201.md)
