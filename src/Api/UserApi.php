...
class UserApi
{
     ...
     *
     * @param  \TextMagic\Models\UpdateCurrentUserResponse $updateUserInputObject updateUserInputObject (optional)
     *
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TextMagic\Models\UpdateCurrentUserResponse
     */
    public function updateCurrentUser($updateUserInputObject = null)
    {
        list($response) = $this->updateCurrentUserWithHttpInfo($updateUserInputObject);
        return $response;
    }
     ...
     * Update current user info.
     *
     * @param  \TextMagic\Models\UpdateCurrentUserResponse $updateUserInputObject (optional)
     *
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TextMagic\Models\UpdateCurrentUserResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCurrentUserWithHttpInfo($updateUserInputObject = null)
    {
        $returnType = '\TextMagic\Models\UpdateCurrentUserResponse';
        $request = $this->updateCurrentUserRequest($updateUserInputObject);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCurrentUserAsync($updateUserInputObject = null)
    {
        return $this->updateCurrentUserAsyncWithHttpInfo($updateUserInputObject)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCurrentUserAsyncWithHttpInfo($updateUserInputObject = null)
    {
        $returnType = '\TextMagic\Models\UpdateCurrentUserResponse';
        $request = $this->updateCurrentUserRequest($updateUserInputObject);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateCurrentUserRequest($updateUserInputObject = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($updateUserInputObject)) {
            $_tempBody = $updateUserInputObject;
        }
