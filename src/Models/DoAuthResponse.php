...
class DoAuthResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'token' => 'string',
        'expires' => '\DateTime',
        'minVersions' => '\TextMagic\Models\DoAuthResponseMinVersions',
    ...
    protected static $attributeMap = [
        ...
        'disallowedRules' => 'disallowedRules'
    ];
    ...
    protected static $setters = [
        ...
        'token' => 'setToken',
        'expires' => 'setExpires',
        'minVersions' => 'setMinVersions',
        'disallowedRules' => 'setDisallowedRules'
    ];
    ...
    protected static $getters = [
        ...
        'disallowedRules' => 'getDisallowedRules'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['minVersions'] = isset($data['minVersions']) ? $data['minVersions'] : null;
        $this->container['disallowedRules'] = isset($data['disallowedRules']) ? $data['disallowedRules'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['minVersions'] === null) {
            $invalidProperties[] = "'minVersions' can't be null";
        }
        if ($this->container['disallowedRules'] === null) {
            $invalidProperties[] = "'disallowedRules' can't be null";
        }
     ...
     * Gets minVersions
     *
     * @return \TextMagic\Models\DoAuthResponseMinVersions
     */
    public function getMinVersions()
    {
        return $this->container['minVersions'];
    }

    /**
     * Sets minVersions
     *
     * @param \TextMagic\Models\DoAuthResponseMinVersions $minVersions minVersions
     *
     * @return $this
     */
    public function setMinVersions($minVersions)
    {
        $this->container['minVersions'] = $minVersions;

        return $this;
    }

    /**
     * Gets disallowedRules
     *
     * @return string[]
     */
    public function getDisallowedRules()
    {
        return $this->container['disallowedRules'];
    }

    /**
     * Sets disallowedRules
     *
     * @param string[] $disallowedRules disallowedRules
     *
     * @return $this
     */
    public function setDisallowedRules($disallowedRules)
    {
        $this->container['disallowedRules'] = $disallowedRules;
