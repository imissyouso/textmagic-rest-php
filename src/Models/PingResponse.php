...
class PingResponse implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['utcDateTime'] = isset($data['utcDateTime']) ? $data['utcDateTime'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['utcDateTime'] === null) {
            $invalidProperties[] = "'utcDateTime' can't be null";
        }
