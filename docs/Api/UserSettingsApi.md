...
> updateInboundMessagesNotificationSettings($updateInboundMessagesNotificationInputObject)
...
$updateInboundMessagesNotificationInputObject = new \TextMagic\Models\UpdateInboundMessagesNotificationInputObject(); // \TextMagic\Models\UpdateInboundMessagesNotificationInputObject | 

try {
    $apiInstance->updateInboundMessagesNotificationSettings($updateInboundMessagesNotificationInputObject);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **updateInboundMessagesNotificationInputObject** | [**\TextMagic\Models\UpdateInboundMessagesNotificationInputObject**](../Model/UpdateInboundMessagesNotificationInputObject.md)|  | [optional]
