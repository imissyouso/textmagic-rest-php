...
> \TextMagic\Models\ResourceLinkResponse clearAndAssignContactsToList($clearAndAssignContactsToListObject, $id)
...
$clearAndAssignContactsToListObject = new \TextMagic\Models\ClearAndAssignContactsToListObject(); // \TextMagic\Models\ClearAndAssignContactsToListObject | Contact ID(s), separated by comma or 'all' to add all contacts belonging to the current user
$id = 1; // int | 

try {
    $result = $apiInstance->clearAndAssignContactsToList($clearAndAssignContactsToListObject, $id);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **clearAndAssignContactsToListObject** | [**\TextMagic\Models\ClearAndAssignContactsToListObject**](../Model/ClearAndAssignContactsToListObject.md)| Contact ID(s), separated by comma or &#39;all&#39; to add all contacts belonging to the current user |
 **id** | **int**|  |
...
# **createList**
> \TextMagic\Models\ResourceLinkResponse createList($createListObject)
...
$createListObject = new \TextMagic\Models\CreateListObject(); // \TextMagic\Models\CreateListObject | 

try {
    $result = $apiInstance->createList($createListObject);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **createListObject** | [**\TextMagic\Models\CreateListObject**](../Model/CreateListObject.md)|  | [optional]
...
> deleteListContactsBulk($id, $deleteListContactsInputObject)
...
$id = 1; // int | 
$deleteListContactsInputObject = new \TextMagic\Models\DeleteListContactsInputObject(); // \TextMagic\Models\DeleteListContactsInputObject | 

try {
    $apiInstance->deleteListContactsBulk($id, $deleteListContactsInputObject);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **id** | **int**|  |
 **deleteListContactsInputObject** | [**\TextMagic\Models\DeleteListContactsInputObject**](../Model/DeleteListContactsInputObject.md)|  | [optional]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **deleteListsBulkInputObject** | [**\TextMagic\Models\DeleteListsBulkInputObject**](../Model/DeleteListsBulkInputObject.md)|  | [optional]
...
# **getContactsByListId**
> \TextMagic\Models\InlineResponse2004 getContactsByListId($id, $page, $limit, $orderBy, $direction)
...
[**\TextMagic\Models\InlineResponse2004**](../Model/InlineResponse2004.md)
...
# **getListsOfContact**
> \TextMagic\Models\InlineResponse2006 getListsOfContact($id, $page, $limit)
...
[**\TextMagic\Models\InlineResponse2006**](../Model/InlineResponse2006.md)
...
# **getUserLists**
> \TextMagic\Models\InlineResponse2006 getUserLists($page, $limit, $orderBy, $direction, $favoriteOnly, $onlyMine)
...
# **searchLists**
> \TextMagic\Models\InlineResponse2006 searchLists($page, $limit, $ids, $query, $onlyMine, $onlyDefault, $orderBy, $direction)
...
# **uploadListAvatar**
> \TextMagic\Models\InlineResponse2011 uploadListAvatar($image, $id)
...
[**\TextMagic\Models\InlineResponse2011**](../Model/InlineResponse2011.md)
