...
> map[string,array] getAllInboundMessages($page, $limit, $orderBy, $direction)
...
> map[string,array] searchInboundMessages($page, $limit, $ids, $query, $orderBy, $direction, $expand)
