...
# **createContactNote**
> \TextMagic\Models\ResourceLinkResponse createContactNote($id, $createContactNoteInputObject)
...
------------- | ------------- | ------------- | -------------
 **id** | **int**|  |
 **createContactNoteInputObject** | [**\TextMagic\Models\CreateContactNoteInputObject**](../Model/CreateContactNoteInputObject.md)|  | [optional]
...
> deleteContactNotesBulk($id, $deleteContactNotesInputObject)
...
$id = 1; // int | 
$deleteContactNotesInputObject = new \TextMagic\Models\DeleteContactNotesInputObject(); // \TextMagic\Models\DeleteContactNotesInputObject | 

try {
    $apiInstance->deleteContactNotesBulk($id, $deleteContactNotesInputObject);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **id** | **int**|  |
 **deleteContactNotesInputObject** | [**\TextMagic\Models\DeleteContactNotesInputObject**](../Model/DeleteContactNotesInputObject.md)|  | [optional]
...
# **getContactNotes**
> \TextMagic\Models\InlineResponse2008 getContactNotes($id, $page, $limit)
...
[**\TextMagic\Models\InlineResponse2008**](../Model/InlineResponse2008.md)
...
# **updateContactNote**
> \TextMagic\Models\ResourceLinkResponse updateContactNote($id, $updateContactNoteInputObject)
...
------------- | ------------- | ------------- | -------------
 **id** | **int**|  |
 **updateContactNoteInputObject** | [**\TextMagic\Models\UpdateContactNoteInputObject**](../Model/UpdateContactNoteInputObject.md)|  | [optional]
