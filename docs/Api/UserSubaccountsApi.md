...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inviteSubaccountInputObject** | [**\TextMagic\Models\InviteSubaccountInputObject**](../Model/InviteSubaccountInputObject.md)|  | [optional]
...
> \TextMagic\Models\User requestNewSubaccountToken($requestNewTokenInputObject)
...
$requestNewTokenInputObject = new \TextMagic\Models\RequestNewTokenInputObject(); // \TextMagic\Models\RequestNewTokenInputObject | 

try {
    $result = $apiInstance->requestNewSubaccountToken($requestNewTokenInputObject);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **requestNewTokenInputObject** | [**\TextMagic\Models\RequestNewTokenInputObject**](../Model/RequestNewTokenInputObject.md)|  | [optional]
