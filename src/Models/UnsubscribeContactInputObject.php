...
/**
 * UnsubscribeContactInputObject Class Doc Comment
 *
 * @category Class
 * @package  TextMagic
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UnsubscribeContactInputObject implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UnsubscribeContactInputObject';
    ...
    protected static $setters = [
        'phone' => 'setPhone',
        'blockIncoming' => 'setBlockIncoming'
    ];
    ...
    protected static $getters = [
        'phone' => 'getPhone',
        'blockIncoming' => 'getBlockIncoming'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['blockIncoming'] = isset($data['blockIncoming']) ? $data['blockIncoming'] : null;
    }
    ...
    {
        return $this->container['blockIncoming'];
    }

    /**
     * Sets blockIncoming
     *
     * @param int $blockIncoming Default is 0 (false). If set to 1 incoming messages from this number will be blocked.
     *
     * @return $this
     */
    public function setBlockIncoming($blockIncoming)
    {
        $this->container['blockIncoming'] = $blockIncoming;
