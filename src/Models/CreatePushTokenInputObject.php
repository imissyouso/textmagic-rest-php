...
/**
 * CreatePushTokenInputObject Class Doc Comment
 *
 * @category Class
 * @package  TextMagic
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreatePushTokenInputObject implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreatePushTokenInputObject';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pushServiceType'] === null) {
            $invalidProperties[] = "'pushServiceType' can't be null";
        }
     ...
     *
     * @param string $pushServiceType Push notification service type: a for Apple Push Notifications, g for Google Cloud Messaging
     *
     * @return $this
     */
