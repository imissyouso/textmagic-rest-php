...
class OutboundMessagesApi
{
     ...
     *
     * @param  \TextMagic\Models\SendSmsInputObject $sendSmsInputObject sendSmsInputObject (optional)
     *
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TextMagic\Models\SendMessageResponse
     */
    public function sendMessage($sendSmsInputObject = null)
    {
        list($response) = $this->sendMessageWithHttpInfo($sendSmsInputObject);
        return $response;
    }
     ...
     * Send a new outbound message.
     *
     * @param  \TextMagic\Models\SendSmsInputObject $sendSmsInputObject (optional)
     *
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TextMagic\Models\SendMessageResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendMessageWithHttpInfo($sendSmsInputObject = null)
    {
        $returnType = '\TextMagic\Models\SendMessageResponse';
        $request = $this->sendMessageRequest($sendSmsInputObject);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendMessageAsync($sendSmsInputObject = null)
    {
        return $this->sendMessageAsyncWithHttpInfo($sendSmsInputObject)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendMessageAsyncWithHttpInfo($sendSmsInputObject = null)
    {
        $returnType = '\TextMagic\Models\SendMessageResponse';
        $request = $this->sendMessageRequest($sendSmsInputObject);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendMessageRequest($sendSmsInputObject = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($sendSmsInputObject)) {
            $_tempBody = $sendSmsInputObject;
        }
