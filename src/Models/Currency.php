...
class Currency implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        'id' => 'setId',
        'unicodeSymbol' => 'setUnicodeSymbol',
        'htmlSymbol' => 'setHtmlSymbol'
    ];
    ...
    protected static $getters = [
        'id' => 'getId',
        'unicodeSymbol' => 'getUnicodeSymbol',
        'htmlSymbol' => 'getHtmlSymbol'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['unicodeSymbol'] = isset($data['unicodeSymbol']) ? $data['unicodeSymbol'] : null;
        $this->container['htmlSymbol'] = isset($data['htmlSymbol']) ? $data['htmlSymbol'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['unicodeSymbol'] === null) {
            $invalidProperties[] = "'unicodeSymbol' can't be null";
        }
        if ($this->container['htmlSymbol'] === null) {
            $invalidProperties[] = "'htmlSymbol' can't be null";
        }
    ...
    {
        return $this->container['unicodeSymbol'];
    }

    /**
     * Sets unicodeSymbol
     *
     * @param string $unicodeSymbol unicodeSymbol
     *
     * @return $this
     */
    public function setUnicodeSymbol($unicodeSymbol)
    {
        $this->container['unicodeSymbol'] = $unicodeSymbol;
    ...
    {
        return $this->container['htmlSymbol'];
    }

    /**
     * Sets htmlSymbol
     *
     * @param string $htmlSymbol htmlSymbol
     *
     * @return $this
     */
    public function setHtmlSymbol($htmlSymbol)
    {
        $this->container['htmlSymbol'] = $htmlSymbol;
