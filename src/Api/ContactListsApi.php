...
class ContactListsApi
{
     ...
     *
     * @param  \TextMagic\Models\ClearAndAssignContactsToListObject $clearAndAssignContactsToListObject Contact ID(s), separated by comma or &#39;all&#39; to add all contacts belonging to the current user (required)
     * @param  int $id id (required)
     *
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TextMagic\Models\ResourceLinkResponse
     */
    public function clearAndAssignContactsToList($clearAndAssignContactsToListObject, $id)
    {
        list($response) = $this->clearAndAssignContactsToListWithHttpInfo($clearAndAssignContactsToListObject, $id);
        return $response;
    }
     ...
     * @return array of \TextMagic\Models\ResourceLinkResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function clearAndAssignContactsToListWithHttpInfo($clearAndAssignContactsToListObject, $id)
    {
        $returnType = '\TextMagic\Models\ResourceLinkResponse';
        $request = $this->clearAndAssignContactsToListRequest($clearAndAssignContactsToListObject, $id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function clearAndAssignContactsToListAsync($clearAndAssignContactsToListObject, $id)
    {
        return $this->clearAndAssignContactsToListAsyncWithHttpInfo($clearAndAssignContactsToListObject, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function clearAndAssignContactsToListAsyncWithHttpInfo($clearAndAssignContactsToListObject, $id)
    {
        $returnType = '\TextMagic\Models\ResourceLinkResponse';
        $request = $this->clearAndAssignContactsToListRequest($clearAndAssignContactsToListObject, $id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function clearAndAssignContactsToListRequest($clearAndAssignContactsToListObject, $id)
    {
        // verify the required parameter 'clearAndAssignContactsToListObject' is set
        if ($clearAndAssignContactsToListObject === null || (is_array($clearAndAssignContactsToListObject) && count($clearAndAssignContactsToListObject) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $clearAndAssignContactsToListObject when calling clearAndAssignContactsToList'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
        ...
        // body params
        $_tempBody = null;
        if (isset($clearAndAssignContactsToListObject)) {
            $_tempBody = $clearAndAssignContactsToListObject;
        }
     ...
     *
     * @param  \TextMagic\Models\CreateListObject $createListObject createListObject (optional)
     *
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TextMagic\Models\ResourceLinkResponse
     */
    public function createList($createListObject = null)
    {
        list($response) = $this->createListWithHttpInfo($createListObject);
        return $response;
    }
     ...
     * Create a new list from the submitted data.
     *
     * @param  \TextMagic\Models\CreateListObject $createListObject (optional)
     *
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TextMagic\Models\ResourceLinkResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createListWithHttpInfo($createListObject = null)
    {
        $returnType = '\TextMagic\Models\ResourceLinkResponse';
        $request = $this->createListRequest($createListObject);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createListAsync($createListObject = null)
    {
        return $this->createListAsyncWithHttpInfo($createListObject)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createListAsyncWithHttpInfo($createListObject = null)
    {
        $returnType = '\TextMagic\Models\ResourceLinkResponse';
        $request = $this->createListRequest($createListObject);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createListRequest($createListObject = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($createListObject)) {
            $_tempBody = $createListObject;
        }
     ...
     *
     * @param  int $id id (required)
     * @param  \TextMagic\Models\DeleteListContactsInputObject $deleteListContactsInputObject deleteListContactsInputObject (optional)
     *
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteListContactsBulk($id, $deleteListContactsInputObject = null)
    {
        $this->deleteListContactsBulkWithHttpInfo($id, $deleteListContactsInputObject);
    }
     ...
     *
     * @param  int $id (required)
     * @param  \TextMagic\Models\DeleteListContactsInputObject $deleteListContactsInputObject (optional)
     *
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteListContactsBulkWithHttpInfo($id, $deleteListContactsInputObject = null)
    {
        $returnType = '';
        $request = $this->deleteListContactsBulkRequest($id, $deleteListContactsInputObject);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteListContactsBulkAsync($id, $deleteListContactsInputObject = null)
    {
        return $this->deleteListContactsBulkAsyncWithHttpInfo($id, $deleteListContactsInputObject)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteListContactsBulkAsyncWithHttpInfo($id, $deleteListContactsInputObject = null)
    {
        $returnType = '';
        $request = $this->deleteListContactsBulkRequest($id, $deleteListContactsInputObject);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteListContactsBulkRequest($id, $deleteListContactsInputObject = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // body params
        $_tempBody = null;
        if (isset($deleteListContactsInputObject)) {
            $_tempBody = $deleteListContactsInputObject;
        }
     ...
     *
     * @param  \TextMagic\Models\DeleteListsBulkInputObject $deleteListsBulkInputObject deleteListsBulkInputObject (optional)
     *
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteListsBulk($deleteListsBulkInputObject = null)
    {
     ...
     * Delete list by given ID(s) or delete all lists.
     *
     * @param  \TextMagic\Models\DeleteListsBulkInputObject $deleteListsBulkInputObject (optional)
     *
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteListsBulkWithHttpInfo($deleteListsBulkInputObject = null)
    {
        $returnType = '';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteListsBulkAsync($deleteListsBulkInputObject = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteListsBulkAsyncWithHttpInfo($deleteListsBulkInputObject = null)
    {
        $returnType = '';
        $request = $this->deleteListsBulkRequest($deleteListsBulkInputObject);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteListsBulkRequest($deleteListsBulkInputObject = null)
    {
     ...
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TextMagic\Models\InlineResponse2006
     */
     ...
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TextMagic\Models\InlineResponse2006, HTTP status code, HTTP response headers (array of strings)
     */
    public function getListsOfContactWithHttpInfo($id, $page = '1', $limit = '10')
    {
        $returnType = '\TextMagic\Models\InlineResponse2006';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TextMagic\Models\InlineResponse2006',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TextMagic\Models\InlineResponse2011
     */
     ...
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TextMagic\Models\InlineResponse2011, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadListAvatarWithHttpInfo($image, $id)
    {
        $returnType = '\TextMagic\Models\InlineResponse2011';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TextMagic\Models\InlineResponse2011',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
