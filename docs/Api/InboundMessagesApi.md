...
> deleteInboundMessagesBulk($deleteInboundMessagesBulkObject)
...
$deleteInboundMessagesBulkObject = new \TextMagic\Models\DeleteInboundMessagesBulkObject(); // \TextMagic\Models\DeleteInboundMessagesBulkObject | 

try {
    $apiInstance->deleteInboundMessagesBulk($deleteInboundMessagesBulkObject);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **deleteInboundMessagesBulkObject** | [**\TextMagic\Models\DeleteInboundMessagesBulkObject**](../Model/DeleteInboundMessagesBulkObject.md)|  | [optional]
...
> \TextMagic\Models\InlineResponse20013 getAllInboundMessages($page, $limit, $orderBy, $direction)
...
[**\TextMagic\Models\InlineResponse20013**](../Model/InlineResponse20013.md)
...
> \TextMagic\Models\InlineResponse20013 searchInboundMessages($page, $limit, $ids, $query, $orderBy, $direction, $expand)
