...
class UpdateSurveyNodeInputObject implements ModelInterface, ArrayAccess
{
     ...
     * Sets isEndNode
     *
     * @param bool $isEndNode Define node is ending for survey. Default is false
     *
     * @return $this
     */
     ...
     * Sets sendDelay
     *
     * @param int $sendDelay Define delay for sending question to recipients after previous answer. Default is 0
     *
     * @return $this
     */
