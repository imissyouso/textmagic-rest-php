...
class CallsApi
{
     ...
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TextMagic\Models\InlineResponse20022
     */
     ...
     * @throws \TextMagic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TextMagic\Models\InlineResponse20022, HTTP status code, HTTP response headers (array of strings)
     */
    public function getForwardedCallsWithHttpInfo($page = '1', $limit = '10')
    {
        $returnType = '\TextMagic\Models\InlineResponse20022';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TextMagic\Models\InlineResponse20022',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
