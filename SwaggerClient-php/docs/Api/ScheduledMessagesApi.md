# Swagger\Client\ScheduledMessagesApi
...
$apiInstance = new Swagger\Client\Api\ScheduledMessagesApi(
...
> deleteScheduledMessagesBulk($delete_scheduled_messages_bulk_input_object, $x_ignore_nullable)
...
$delete_scheduled_messages_bulk_input_object = new \Swagger\Client\Model\DeleteScheduledMessagesBulkInputObject(); // \Swagger\Client\Model\DeleteScheduledMessagesBulkInputObject | 
$x_ignore_nullable = true; // bool | 

try {
    $apiInstance->deleteScheduledMessagesBulk($delete_scheduled_messages_bulk_input_object, $x_ignore_nullable);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **delete_scheduled_messages_bulk_input_object** | [**\Swagger\Client\Model\DeleteScheduledMessagesBulkInputObject**](../Model/DeleteScheduledMessagesBulkInputObject.md)|  |
...
> map[string,object] getAllScheduledMessages($page, $limit, $status, $order_by, $direction)
...
try {
    $result = $apiInstance->getAllScheduledMessages($page, $limit, $status, $order_by, $direction);
    print_r($result);
} catch (Exception $e) {
...
# **getScheduledMessage**
> \Swagger\Client\Model\MessagesIcs getScheduledMessage($id)
...
[**\Swagger\Client\Model\MessagesIcs**](../Model/MessagesIcs.md)
...
> map[string,object] searchScheduledMessages($page, $limit, $query, $ids, $status, $order_by, $direction)
...
try {
    $result = $apiInstance->searchScheduledMessages($page, $limit, $query, $ids, $status, $order_by, $direction);
    print_r($result);
} catch (Exception $e) {
