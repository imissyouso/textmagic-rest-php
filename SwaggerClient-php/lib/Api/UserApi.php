...
class UserApi
{
     ...
     *
     * @param  \Swagger\Client\Model\UpdateCurrentUserInputObject $update_current_user_input_object update_current_user_input_object (required)
     * @param  bool $x_ignore_nullable x_ignore_nullable (optional, default to true)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\UpdateCurrentUserResponse
     */
    public function updateCurrentUser($update_current_user_input_object, $x_ignore_nullable = 'true')
    {
        list($response) = $this->updateCurrentUserWithHttpInfo($update_current_user_input_object, $x_ignore_nullable);
        return $response;
    }
     ...
     * Update current user info.
     *
     * @param  \Swagger\Client\Model\UpdateCurrentUserInputObject $update_current_user_input_object (required)
     * @param  bool $x_ignore_nullable (optional, default to true)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\UpdateCurrentUserResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCurrentUserWithHttpInfo($update_current_user_input_object, $x_ignore_nullable = 'true')
    {
        $returnType = '\Swagger\Client\Model\UpdateCurrentUserResponse';
        $request = $this->updateCurrentUserRequest($update_current_user_input_object, $x_ignore_nullable);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\UpdateCurrentUserResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCurrentUserAsync($update_current_user_input_object, $x_ignore_nullable = 'true')
    {
        return $this->updateCurrentUserAsyncWithHttpInfo($update_current_user_input_object, $x_ignore_nullable)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCurrentUserAsyncWithHttpInfo($update_current_user_input_object, $x_ignore_nullable = 'true')
    {
        $returnType = '\Swagger\Client\Model\UpdateCurrentUserResponse';
        $request = $this->updateCurrentUserRequest($update_current_user_input_object, $x_ignore_nullable);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateCurrentUserRequest($update_current_user_input_object, $x_ignore_nullable = 'true')
    {
        // verify the required parameter 'update_current_user_input_object' is set
        if ($update_current_user_input_object === null || (is_array($update_current_user_input_object) && count($update_current_user_input_object) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_current_user_input_object when calling updateCurrentUser'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($update_current_user_input_object)) {
            $_tempBody = $update_current_user_input_object;
        }
